...
# A funcao que le textos na interface com o usuario
def le_textos():
    i = 1
    textos = []
...
# Essa funcao recebe uma lista de textos e deve devolver o numero (1 a n) do texto com maior probabilidade de ter
...
# Media simples do numero de caracteres por sentença, sem os caracteres delimitadores
...
# número total de frases divido pelo numero de sentenças
...
# soma do numero de caracteres em cada frase dividida pelo numero de frases no texto, sem os separadores,
# sem os caracteres delimitadores
